...
function onTrade(player,npc,trade)
	...
	if(CurrentMission ~= 255) then
		...
		elseif(CurrentMission == BAT_HUNT and trade:hasItemQty(1112,1) and Count == 1 and BatHuntCompleted == false and MissionStatus == 0) then -- Trade Orcish Mail Scales
			player:startEvent(0x03ff); -- Finish Mission "Bat Hunt"
		elseif(CurrentMission == BAT_HUNT and trade:hasItemQty(891,1) and Count == 1 and BatHuntCompleted and MissionStatus == 0) then -- Trade Bat Fang
